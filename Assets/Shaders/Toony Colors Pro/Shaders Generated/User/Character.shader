...
Shader "Toony Colors Pro 2/User/Character"
{
	...
	[Header(Masks)]
		_Mask1 ("Mask 1 (Color2)", 2D) = "black" {}
		_Mask2 ("Mask 2 (Color3)", 2D) = "black" {}
		_Mask3 ("Mask 3 (Color4)", 2D) = "black" {}
	[TCP2Separator]
	...
	float4 tex2DnoTile( sampler2D samp, in float2 uv )
	{
		...
		void surf(Input IN, inout SurfaceOutputCustom o)
		{
			...
			_Color = lerp(fixed4(1,1,1,1), _Color, mainTex.r * _ColorMaskStrength);
			o.Albedo = mainTex.rgb * _Color.rgb;
			o.Albedo.rgb += _MaskedColor2.rgb * mask1.r * _MaskedColor2.a;
			o.Albedo.rgb += _MaskedColor3.rgb * mask2.r * _MaskedColor3.a;
			o.Albedo.rgb += _MaskedColor4.rgb * mask3.r * _MaskedColor4.a;
